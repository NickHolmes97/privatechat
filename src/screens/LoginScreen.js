...
const s = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: colors.textSecondary, marginBottom: 36 },
  card: { width: '100%', backgroundColor: colors.glassBg, borderRadius: 16, borderWidth: 1, borderColor: colors.glassBorder, padding: 24 },
  ...
  btn: { backgroundColor: colors.purple, borderRadius: 12, paddingVertical: 14, alignItems: 'center' },

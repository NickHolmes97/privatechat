...
const s = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingTop: 48, paddingBottom: 10, paddingHorizontal: 12, backgroundColor: colors.surface, borderBottomWidth: 0.5, borderBottomColor: colors.glassBorder },
  backBtn: { padding: 8 },
  ...
  dateSepText: { color: colors.textSecondary, fontSize: 12, marginHorizontal: 12, fontWeight: '500', backgroundColor: 'rgba(0,0,0,0.2)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, overflow: 'hidden' },
  msgRow: { marginVertical: 2, alignItems: 'flex-start' },
  msgRowMe: { alignItems: 'flex-end' },
  senderName: { color: colors.purple, fontSize: 13, fontWeight: '600', marginBottom: 1 },
  bubble: { maxWidth: '80%', borderRadius: 12, paddingHorizontal: 10, paddingVertical: 6 },
  bubbleMe: { backgroundColor: colors.bubbleOut, borderBottomRightRadius: 2 },
  bubbleCircle: { backgroundColor: "transparent", padding: 0, borderRadius: 0 },
  bubbleOther: { backgroundColor: colors.bubbleIn, borderBottomLeftRadius: 2 },
  ...
  msgImage: { width: 220, height: 180, borderRadius: 10, marginBottom: 2 },
  ...
  inputBtn: { padding: 8 },
  input: { flex: 1, backgroundColor: colors.surfaceLight, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 10, color: colors.text, fontSize: 16, maxHeight: 100 },
  sendBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.purple, justifyContent: 'center', alignItems: 'center', marginLeft: 4 },
  ...
  ctxMenu: { backgroundColor: colors.surface, borderRadius: 16, padding: 16, width: '85%', maxWidth: 340, elevation: 4 },
  ...
  reactions: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 12, backgroundColor: colors.surfaceLight, borderRadius: 24, paddingVertical: 8, paddingHorizontal: 4 },
  reactBtn: { padding: 6 },

...
const s = StyleSheet.create({
  ...
  // Attach menu
  attachMenu: { flexDirection: 'row', backgroundColor: colors.surface, paddingVertical: 16, paddingHorizontal: 12, gap: 12, justifyContent: 'center' },
  attachItem: { alignItems: 'center', width: 70 },
  attachIcon: { width: 48, height: 48, borderRadius: 24, justifyContent: 'center', alignItems: 'center', marginBottom: 6 },
  ...
  ctxMenu: { backgroundColor: colors.surface, borderRadius: 20, padding: 16, width: '85%', maxWidth: 340 },
